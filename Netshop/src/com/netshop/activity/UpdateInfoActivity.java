...
public class UpdateInfoActivity extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle bundle){
		...
		if(intType == PersonInfoActivity.SEX){
			...
			request.request(new HttpCallBack() {
				...
				public void success(String json) {
					...
					adapter = new ArrayAdapter<String>(UpdateInfoActivity.this, android.R.layout.simple_spinner_item, areaList);
	...
	public void onClick(View v) {
		...
		case R.id.person_commit:
			...
			request.request(HttpRequest.REQUEST_GET, new HttpCallBack() {
				...
				@Override
				public void fail(String failReason) {
					Toast.makeText(UpdateInfoActivity.this, failReason, Toast.LENGTH_SHORT).show();
				}
			});
		}
