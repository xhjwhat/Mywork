...
import com.netshop.fragment.Phone2Fragment;
...
public class PhoneChangeActivity extends FragmentActivity {
	ImageView backImg;
	TextView title;
	...
	public void onCreate(Bundle bundle){
		...
		title.setText("修改手机验证");
		manager = getSupportFragmentManager();
		FragmentTransaction transaction =manager.beginTransaction();
		Phone2Fragment fragment = new Phone2Fragment();
